...
int acrxEntryPoint(AcRx::AppMsgCode Msg, void* pkt)
{
    ...
    case AcRx::kInitAppMsg:
        ...
        acedRegCmds->addCommand(L"AUCommands", _T("AddLine"), _T("AddLine"), ACRX_CMD_MODAL, &CAssignment1App::AddLine);
        break;
...
BEGIN_MESSAGE_MAP(CAssignment2App, CWinApp)
END_MESSAGE_MAP()



CAssignment2App::CAssignment2App()
{

}


CAssignment2App theApp;


BOOL CAssignment2App::InitInstance()
{
